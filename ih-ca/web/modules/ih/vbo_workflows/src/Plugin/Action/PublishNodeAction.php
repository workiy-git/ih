 ...
 *
 * @Action(
 *   id = "vbo_workflows_publish_node_action",
  ...
  public function execute(ContentEntityInterface $entity = NULL) {
    ...
    if (!empty($state)) {
      if ($state == 'review') {
        ...
        // Set the moderation state as published.
        ...
        $this->messenger()->addWarning(t('%title  - cannot change state directly from %state to published', [
          '%title' => $entity->getTitle(),
          '%state' => $state,
        ]));
      }
      ...
      $this->messenger()->addWarning(t('%title  - cannot change state', ['%title' => $entity->getTitle()]));
    }
  }

 ...
 */
class PopularTopics extends ConfigFormBase {

  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'popular_topics_config';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $config = $this->config('popular_topics.settings');
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $config = $this->configFactory->getEditable('popular_topics.settings');
